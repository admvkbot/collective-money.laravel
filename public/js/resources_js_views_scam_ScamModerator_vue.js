...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    sendSetScamProjectStatusData: function sendSetScamProjectStatusData(messageId) {
      var _this3 = this;

      axios.post("/api/pre-scam-project/" + messageId, {
        tgUsername: this.tgUserData.username,
        tgUserId: this.tgUserData.id,
        projectId: this.projectData.id
      }).then(function (r) {
...
/* harmony import */ var _assets_js_convertDate_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/assets/js/convertDate.js */ "./resources/js/assets/js/convertDate.js");
/* harmony import */ var _components_modal_AddScamModal_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/components/modal/AddScamModal.vue */ "./resources/js/components/modal/AddScamModal.vue");
/* harmony import */ var _assets_js_searchTgUsername_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/assets/js/searchTgUsername.js */ "./resources/js/assets/js/searchTgUsername.js");
/* harmony import */ var _assets_js_searchProject_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/assets/js/searchProject.js */ "./resources/js/assets/js/searchProject.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    AddScamModal: _components_modal_AddScamModal_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    searchTgUsername: _assets_js_searchTgUsername_js__WEBPACK_IMPORTED_MODULE_4__["default"],
    searchProject: _assets_js_searchProject_js__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  props: {
    title: {
      type: String,
  ...
  setup: function setup(props) {
    var searchTerm = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(""); // Search text
    // Fake data

    var data = (0,vue__WEBPACK_IMPORTED_MODULE_1__.reactive)({
      rows: []
    });
    var $loading = (0,vue_loading_overlay__WEBPACK_IMPORTED_MODULE_6__.useLoading)();
    var loader;
    ...
    var table = (0,vue__WEBPACK_IMPORTED_MODULE_1__.reactive)({
      filteredList: (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(function () {
        return data.rows;
      }),
      totalRecordCount: (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(function () {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.watch)(table, function (val) {
      console.log(val);
  ...
  mounted: function mounted() {
    this.theModal = new bootstrap__WEBPACK_IMPORTED_MODULE_7__.Modal(document.getElementById("addScamMessage")); //this.submit();
  },
  methods: {
    checkString: function checkString(string) {
      ...
      if (string.match(regexp)) {
        ...
        this.tgUserData = (0,_assets_js_searchTgUsername_js__WEBPACK_IMPORTED_MODULE_4__["default"])(username, true);
        this.projectData = {
          id: null,
          name: ""
        };
      } else if (string.match(regexp2)) {
        this.tgUserData = (0,_assets_js_searchTgUsername_js__WEBPACK_IMPORTED_MODULE_4__["default"])(string, false);
        this.projectData = (0,_assets_js_searchProject_js__WEBPACK_IMPORTED_MODULE_5__["default"])(string);
    ...
    convertDate: function convertDate(date) {
      return (0,_assets_js_convertDate_js__WEBPACK_IMPORTED_MODULE_2__.convertMessageTableDate)(date);
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [_hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", null, [$props.tgUserData.username || $props.projectData.name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_6, [$props.tgUserData.username ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_7, [_hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_vsud_input, {
    id: "tg-user-name",
    type: "text",
  ...
  , ["value"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
  ...
  }, " Подтвердить ")])])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $props.projectData.name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_12, [_hoisted_13, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_vsud_input, {
    id: "project-name",
    type: "text",
    ...
    onInputValue: _cache[2] || (_cache[2] = function (v) {
      return $props.projectData.name = v;
    })
  }, null, 8
  /* PROPS */
  , ["value"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    ...
    onClick: _cache[3] || (_cache[3] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
      return $options.sendSetScamProjectStatusData($props.messageId);
    }, ["prevent"]))
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["modal", "rawString", "tgUserData", "projectData", "messageId", "onMesagesReload"])])])], 64
  /* STABLE_FRAGMENT */
  );
}
...
/***/ "./resources/js/assets/js/searchProject.js":
/*!*************************************************!*\
  !*** ./resources/js/assets/js/searchProject.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ searchProject)
/* harmony export */ });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.esm-bundler.js");
...
function searchProject(query) {
  ...
  var connectSearchProject = function connectSearchProject(query) {
    return axios.post("/api/search-project", {
      query: query
    }).then(function (r) {
      if (r.data) {
        project.value = {
  ...
  connectSearchProject(query); //watch(user, getUserRepositories)
