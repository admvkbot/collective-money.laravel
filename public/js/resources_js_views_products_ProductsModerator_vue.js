  ...
  /* NEED_PATCH */
    ...
    , ["to"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
      ...
      onClick: function onClick($event) {
        return $options.confirm(item.id, 'Удалить проект?', 'Удаление проекта вместе с его статистикой, индексами и блоком timeline');
      }
    }, "Удалить", 8
    /* PROPS */
    , _hoisted_37)])], 8
