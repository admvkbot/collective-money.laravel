...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var setIsRegister = function setIsRegister(nowRegister) {
  ...
  validations: function validations() {
    return {
      invite: {
        ...
        minLengthValue: (0,_vuelidate_validators__WEBPACK_IMPORTED_MODULE_2__.minLength)(8)
      },
      email: {
      ...
      password: {
        ...
        passwordConfirmation: {
          required: _vuelidate_validators__WEBPACK_IMPORTED_MODULE_2__.required,
          sameAs: (0,_vuelidate_validators__WEBPACK_IMPORTED_MODULE_2__.sameAs)(this.password.password)
        }
      }
    };
  },
  methods: {
    register: function register(v) {
      var _this = this;

      if (!this.showInviteError(v.invite) && !this.showEmailError(v.email) && !this.showPasswordError(v.password.password) && !this.showPasswordConfirmationError(v.password.passwordConfirmation)) {
        axios.get("/sanctum/csrf-cookie").then(function (response) {
          axios.post("/register", {
            invite: _this.invite,
            email: _this.email,
            password: _this.password.password
          }).then(function (r) {
            localStorage.setItem("x_xsrf_token", r.config.headers["X-XSRF-TOKEN"]);
            localStorage.setItem("invite", v.invite);
            _this.registerError = "";

            _this.$router.push("user.personal.firstTab");
          })["catch"](function (err) {
            console.log(err.response);
            _this.registerError = "Registration error";
          });
        });
      }
    },
    showEmailError: function showEmailError(event) {
      if (event.$invalid) {
    ...
    showInviteError: function showInviteError(event) {
      if (event.$invalid) {
    ...
    showPasswordError: function showPasswordError(event) {
      if (event.$invalid) {
    ...
    showPasswordConfirmationError: function showPasswordConfirmationError(event) {
      if (event.$invalid) {
...
var _hoisted_3 = {
  "class": "column is-8 is-offset-2 register"
};
var _hoisted_4 = {
  "class": "columns"
};
...
var _hoisted_5 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  "class": "title is-1"
}, "Super Cool Website"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", {
  "class": "subtitle colored is-4"
}, "Lorem ipsum dolor sit amet."), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, " Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corporis ex deleniti aliquam tempora libero excepturi vero soluta odio optio sed. ")], -1
/* HOISTED */
);

var _hoisted_6 = {
  "class": "column right has-text-centered"
};
var _hoisted_7 = {
  key: 0,
...
var _hoisted_23 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("small", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("em", null, "Lorem ipsum dolor sit amet consectetur.")], -1
/* HOISTED */
);
...
var _hoisted_25 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"column is-8 is-offset-2\"><br><nav class=\"level\"><div class=\"level-left\"><div class=\"level-item\"><span class=\"icon\"><i class=\"fab fa-twitter\"></i></span>   <span class=\"icon\"><i class=\"fab fa-facebook\"></i></span>   <span class=\"icon\"><i class=\"fab fa-instagram\"></i></span>   <span class=\"icon\"><i class=\"fab fa-github\"></i></span>   <span class=\"icon\"><i class=\"fas fa-envelope\"></i></span></div></div><div class=\"level-right\"><small class=\"level-item\" style=\"color:var(--textLight);\"> © Super Cool Website. All Rights Reserved. </small></div></nav></div>", 1);

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [_hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [$data.registerError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.registerError), 1
  /* TEXT */
  )) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _hoisted_8, _hoisted_9, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    ...
    onBlur: _cache[1] || (_cache[1] = function ($event) {
      return $options.showEmailError($setup.v$.email);
    })
  }, null, 544
  /* HYDRATE_EVENTS, NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.email, void 0, {
    trim: true
  }]])]), $data.emailStatus ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.emailStatus), 1
  /* TEXT */
    ...
    "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
      return $data.password.password = $event;
    }),
    "class": "input is-medium",
    type: "password",
    placeholder: "Password",
    onBlur: _cache[3] || (_cache[3] = function ($event) {
      return $options.showPasswordError($setup.v$.password.password);
    })
  }, null, 544
  /* HYDRATE_EVENTS, NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.password.password]])]), $data.passwordStatus ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_15, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.passwordStatus), 1
  /* TEXT */
    ...
    "onUpdate:modelValue": _cache[4] || (_cache[4] = function ($event) {
      return $data.password.passwordConfirmation = $event;
    }),
    "class": "input is-medium",
    type: "password",
    placeholder: "Repeate password",
    onBlur: _cache[5] || (_cache[5] = function ($event) {
      return $options.showPasswordConfirmationError($setup.v$.password.passwordConfirmation);
    })
  }, null, 544
  /* HYDRATE_EVENTS, NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.password.passwordConfirmation]])]), $data.passwordConfirmationStatus ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_18, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.passwordConfirmationStatus), 1
  /* TEXT */
    ...
    "onUpdate:modelValue": _cache[6] || (_cache[6] = function ($event) {
      return $data.invite = $event;
    }),
    "class": "input is-medium",
    type: "text",
    placeholder: "Invite",
    onBlur: _cache[7] || (_cache[7] = function ($event) {
      return $options.showInviteError($setup.v$.invite);
    })
  }, null, 544
  /* HYDRATE_EVENTS, NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.invite, void 0, {
    trim: true
  }]])]), $data.inviteStatus ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.inviteStatus), 1
  /* TEXT */
  )) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    onClick: _cache[8] || (_cache[8] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
      return $options.register($setup.v$);
    }, ["prevent"])),
    "class": "button is-block is-primary is-fullwidth is-medium"
  }, " Sign up "), _hoisted_22, _hoisted_23, _hoisted_24, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("<div :class=\"{ error: v$.email.$errors.length }\">\n                <input v-model=\"email\" />\n                <div\n                  class=\"input-errors\"\n                  v-for=\"error of v$.email.$errors\"\n                  :key=\"error.$uid\"\n                >\n                  <div class=\"error-msg\">{{ error.$message }}</div>\n                </div>\n              </div>")])])])]), _hoisted_25])]);
}
