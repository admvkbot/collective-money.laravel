...
Route::group(['middleware' => 'auth:sanctum'], function () {
   ...
   Route::post('/edit-product-activity/{activity_id}', 'ProductActivity\EditController');
   Route::get('/delete-product-activity/{activity_id}', 'ProductActivity\DeleteController');
